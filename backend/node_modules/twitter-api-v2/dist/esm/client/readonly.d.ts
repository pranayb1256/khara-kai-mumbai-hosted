import type TwitterApi from 'twitter-api-v2/dist/esm/client';
import TwitterApiBase from 'twitter-api-v2/dist/esm/client.base';
import { AccessOAuth2TokenArgs, AccessOAuth2TokenResult, BuildOAuth2RequestLinkArgs, IOAuth2RequestTokenResult, IParsedOAuth2TokenResult, LoginResult, RequestTokenArgs, Tweetv2SearchParams } from 'twitter-api-v2/dist/esm/types';
...
export default class TwitterApiReadOnly extends TwitterApiBase {
     ...
     */
    currentUser(forceFetch?: boolean): Promise<import("twitter-api-v2/dist/esm/types").UserV1>;
    /**
     * Fetch and cache current user.
     ...
     */
    currentUserV2(forceFetch?: boolean): Promise<import("twitter-api-v2/dist/esm/types").UserV2Result>;
    search(what: string, options?: Partial<Tweetv2SearchParams>): Promise<import("twitter-api-v2").TweetSearchRecentV2Paginator>;
    /**
