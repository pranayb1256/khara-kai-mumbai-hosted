import { TwitterRateLimit, TwitterResponse } from 'twitter-api-v2/dist/esm/types';
...
export declare abstract class TwitterPaginator<TApiResult, TApiParams extends object, TItem, TParams = any> {
    ...
    get rateLimit(): {
        day?: import("twitter-api-v2/dist/esm/types").SingleTwitterRateLimit | undefined;
        userDay?: import("twitter-api-v2/dist/esm/types").SingleTwitterRateLimit | undefined;
        limit: number;
        reset: number;
        remaining: number;
    };
