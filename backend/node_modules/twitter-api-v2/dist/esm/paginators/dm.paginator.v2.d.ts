...
import { DMEventV2, GetDMEventV2Params, GetDMEventV2Result } from 'twitter-api-v2/dist/esm/types/v2/dm.v2.types';
export declare abstract class DMTimelineV2Paginator<TShared = any> extends TimelineV2Paginator<GetDMEventV2Result, GetDMEventV2Params, DMEventV2, TShared> {
    ...
    get meta(): import("twitter-api-v2/dist/esm/types/v2/shared.v2.types").PaginableCountMetaV2;
}
