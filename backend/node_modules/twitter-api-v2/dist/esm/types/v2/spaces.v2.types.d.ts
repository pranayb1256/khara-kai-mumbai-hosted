...
import type { DataAndIncludeV2, DataMetaAndIncludeV2 } from 'twitter-api-v2/dist/esm/types/v2/shared.v2.types';
import type { TTweetv2UserField } from 'twitter-api-v2/dist/esm/types/v2/tweet.v2.types';
import type { UsersV2Params, UsersV2Result, UserV2 } from 'twitter-api-v2/dist/esm/types/v2/user.v2.types';
...
export declare type TSpaceV2Expansion = 'invited_user_ids' | 'speaker_ids' | 'creator_id' | 'host_ids' | 'topic_ids';
...
export declare type TSpaceV2State = 'canceled' | 'ended' | 'live' | 'scheduled';
...
export declare type SpaceV2SingleResult = DataAndIncludeV2<SpaceV2, SpaceV2Includes>;
