...
import type { IGetHttpRequestArgs } from 'twitter-api-v2/dist/esm/types/request-maker.mixin.types';
import type { TwitterResponse } from 'twitter-api-v2/dist/esm/types/responses.types';
import type { IComputedHttpRequestArgs } from 'twitter-api-v2/dist/esm/types/request-maker.mixin.types';
import type { IOAuth2RequestTokenResult, RequestTokenResult } from 'twitter-api-v2/dist/esm/types/auth.types';
import type { PromiseOrType } from 'twitter-api-v2/dist/esm/types/shared.types';
import type { ApiResponseError, ApiRequestError, ApiPartialResponseError } from 'twitter-api-v2/dist/esm/types/errors.types';
import type { ClientRequestMaker } from 'twitter-api-v2/dist/esm/client-mixins/request-maker.mixin';
