...
import type { ListCreateV2Params, ListCreateV2Result, ListDeleteV2Result, ListFollowV2Result, ListMemberV2Result, ListPinV2Result, ListUpdateV2Params, ListUpdateV2Result, TweetV2DeleteTweetResult, SendTweetV2Params, TweetV2HideReplyResult, TweetV2LikeResult, TweetV2PostTweetResult, TweetV2RetweetResult, UserV2BlockResult, UserV2FollowResult, UserV2MuteResult, UserV2UnfollowResult, TweetV2BookmarkResult, EUploadMimeType } from 'twitter-api-v2/dist/esm/types';
import TwitterApiv2LabsReadWrite from 'twitter-api-v2/dist/esm/v2-labs/client.v2.labs.write';
import { CreateDMConversationParams, PostDMInConversationParams, PostDMInConversationResult } from 'twitter-api-v2/dist/esm/types/v2/dm.v2.types';
import { MediaV2MediaCategory, MediaV2MetadataCreateParams, MediaV2MetadataCreateResult } from 'twitter-api-v2/dist/esm/types/v2/media.v2.types';
/**
...
export default class TwitterApiv2ReadWrite extends TwitterApiv2ReadOnly {
     ...
     */
    uploadMedia(media: Buffer, options: {
     ...
     */
    createMediaMetadata(mediaId: string, metadata: Partial<MediaV2MetadataCreateParams>): Promise<MediaV2MetadataCreateResult>;
    /**
