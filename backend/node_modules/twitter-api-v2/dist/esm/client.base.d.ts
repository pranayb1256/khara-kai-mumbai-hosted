import type { IClientSettings, ITwitterApiClientPlugin, TwitterApiBasicAuth, TwitterApiOAuth2Init, TwitterApiTokens, TwitterRateLimit, TwitterResponse, UserV1, UserV2Result } from 'twitter-api-v2/dist/esm/types';
import { ClientRequestMaker } from 'twitter-api-v2/dist/esm/client-mixins/request-maker.mixin';
import TweetStream from 'twitter-api-v2/dist/esm/stream/TweetStream';
import { SharedPromise } from 'twitter-api-v2/dist/esm/helpers';
import type { TCustomizableRequestArgs, TRequestBody, TRequestQuery } from 'twitter-api-v2/dist/esm/types/request-maker.mixin.types';
...
export default abstract class TwitterApiBase {
    ...
    getActiveTokens(): import("twitter-api-v2/dist/esm/types").TClientTokens;
